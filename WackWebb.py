"""
Fit unoriented Wack and Webb data with M1G model. Uncertainties are taken
to be sqrt(I) = |F|
"""
...
m1g.link_psi = True
m1g.fit_edp()
#m1g.export_model_F("fits/WackWebb_F.txt")
#m1g.export_model_I("fits/WackWebb_I.txt")
#m1g.export_2D_edp("fits/WackWebb_2D_edp.txt")
#m1g.export_params("fits/WackWebb_params.txt")
