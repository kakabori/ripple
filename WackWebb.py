...
###############################################################################
  # This initial parameter set results in chisqr = 288
  # A = 19.7, x0 = 104.1
  ...
  m1g.link_psi = True
  m1g.fit_edp()
  m1g.export_model_F("WackWebb_F.txt")
  m1g.export_model_I("WackWebb_I.txt")
  m1g.export_2D_edp("WackWebb_2D_edp.txt")
  m1g.export_params("WackWebb_params.txt")
  m1g.export_angle("WackWebb_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
  m1g.export_angle("WackWebb_1D_minor.txt", center=(70.85,0), angle=27.1, length=100, stepsize=0.1)
  m1g.report_edp()  
  
###############################################################################
  # This initial parameter set results in chisqr = 285
  # A = 21.0, x0 = 112.0
  m1g = M1G(h, k, q, I, sigma, D=57.94, lambda_r=141.7, gamma=1.717,
