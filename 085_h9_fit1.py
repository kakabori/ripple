...
#  m1g.fit_lattice()
  ...
  m1g.export_angle("fit1_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
  m1g.export_angle("fit1_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
  m1g.report_edp()   
