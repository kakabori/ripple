...
m2g = M2G(h, k, q, I, sigma, D=57.8, lambda_r=145.0, gamma=1.714,
          x0=120, A=25, f1=1.5, f2=-20, 
          rho_H1=9.91, Z_H1=18, sigma_H1=2.94,
          rho_H2=7.27, Z_H2=23, sigma_H2=1.47, 
...
m2g.report_edp()
#m2g.export_model_F("fits/fit4_F.txt")
#m2g.export_model_I("fits/fit4_I.txt")
#m2g.export_2D_edp("fits/fit4_2D_edp.txt")
#m2g.export_params("fits/fit4_params.txt")
#m2g.export_angle("fits/fit4_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
#m2g.export_angle("fits/fit4_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
m2g.export_headgroup_positions("fits/fit4_headgroup.txt")
m2g.export_phases("fits/fit4_phases.txt")
