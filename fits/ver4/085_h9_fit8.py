...
#  m1g.fit_lattice()
  ...
  m1g.link_psi = True
  m1g.fit_edp()
  m1g.export_model_F("fit8_F.txt")
  m1g.export_model_I("fit8_I.txt")
  m1g.export_2D_edp("fit8_2D_edp.txt")
  m1g.export_params("fit8_params.txt")
  m1g.export_angle("fit8_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
  m1g.export_angle("fit8_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
  m1g.report_edp()   
