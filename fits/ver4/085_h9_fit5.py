...
m2g.export_angle("fit5_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
m2g.export_angle("fit5_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
