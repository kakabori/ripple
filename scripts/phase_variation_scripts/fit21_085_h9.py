...
#m2g.export_2D_edp("fits/fit21_2D_edp.txt")
#m2g.export_angle("fits/fit21_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
#m2g.export_angle("fits/fit21_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
m2g.export_headgroup_positions("fits/fit21_headgroup.txt")
m2g.export_phases("fits/fit21_phases.txt")
m2g.phase[(m2g.h==1)&(m2g.k==3)] *= -1
m2g.phase[(m2g.h==3)&(m2g.k==0)] *= -1
m2g.phase[(m2g.h==6)&(m2g.k==0)] *= -1
m2g.phase[(m2g.h==9)&(m2g.k==0)] *= -1
