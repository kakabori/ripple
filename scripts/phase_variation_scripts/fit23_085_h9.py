...
# Dr. Nagle and I both feel that (1,3) should be positive.
# From Fit22, it seems that weird bump in the minor arm region of Fit5
# can be rid of by some or all of following phases.
...
#m2g.export_2D_edp("fits/fit23_2D_edp.txt")
#m2g.export_angle("fits/fit23_1D_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
#m2g.export_angle("fits/fit23_1D_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
m2g.export_headgroup_positions("fits/fit23_headgroup.txt")
m2g.export_phases("fits/fit23_phases.txt")
m2g.phase[(m2g.h==3)&(m2g.k==0)] *= -1
m2g.phase[(m2g.h==6)&(m2g.k==0)] *= -1
m2g.phase[(m2g.h==6)&(m2g.k==1)] *= -1
m2g.phase[(m2g.h==6)&(m2g.k==3)] *= -1
