...
m1g.link_sigma_H = False
m1g.edp_par['rho_M_major'].vary = False
m1g.edp_par['rho_M_minor'].vary = False
m1g.link_rho_M = False
m1g.edp_par['sigma_M_major'].vary = False
m1g.edp_par['sigma_M_minor'].vary = True
m1g.link_sigma_M = False
m1g.edp_par['psi_major'].vary = True
m1g.edp_par['psi_minor'].vary = True
m1g.link_psi = False
m1g.fit_edp()
#m1g.export_model_F("fits/fit1_F.txt")
#m1g.export_model_I("fits/fit1_I.txt")
#m1g.export_EDM("fits/fit1_edm.txt")
#m1g.export_params("fits/fit1_params.txt")
#m1g.export_EDP("fits/fit1_edp_major.txt", center=(0,0), angle=-11.8, length=100, stepsize=0.1)
#m1g.export_EDP("fits/fit1_edp_minor.txt", center=(72.5,0), angle=27.1, length=100, stepsize=0.1)
