...
if __name__ == "__main__":
  ...
  infilename = 'intensity/085_h7.dat'
...
#  m1g.fit_lattice()
  ...
  m1g.fit_edp()
  m1g.export_model_F("h7_F_m1g.dat")
#  m1g.report_edp()   
...
#  m2g.fit_lattice()
  ...
  m2g.fit_edp()
  m2g.export_model_F("h7_F_m2g.dat")
  m2g.report_edp()
...
#  s2g.fit_edp()
#  s2g.export_model_F("h7_F_s2g.dat")
#  s2g.report_edp()
...
#  s1g.fit_edp()
#  s1g.export_model_F("h7_F_s1g.dat")
#  s1g.report_edp()  
