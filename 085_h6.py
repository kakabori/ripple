...
#  sdf.fit_lattice()
  sdf.fit_edp()
  sdf.export_model_F("h6_F_sdf.dat")
#  sdf.report_edp()
...
#  mdf.set_mask(h=2, k=0, value=False)
  mdf.fit_edp()
  mdf.export_model_F("h6_F_mdf.dat")
#  mdf.report_edp()  
...
#  s1g.fit_lattice()
  ...
  s1g.fit_edp()
  s1g.export_model_F("h6_F_s1g.dat")
#  s1g.report_edp()            
...
#  m1g.fit_lattice()
  ...
  m1g.fit_edp()
  m1g.export_model_F("h6_F_m1g.dat")
#  m1g.report_edp()   
...
#  s2g.fit_lattice()
  ...
  s2g.fit_edp()
  s2g.export_model_F("h6_F_s2g.dat")
#  s2g.report_edp()
...
#  m2g.fit_lattice()
  ...
  m2g.fit_edp()
  m2g.export_model_F("h6_F_m2g.dat")
#  s2g.report_edp()
