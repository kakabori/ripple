...
m2g.report_edp()
m2g.export_model_F("fit5_F.txt")
m2g.export_model_I("fit5_I.txt")
m2g.export_2D_edp("fit5_2D_edp.txt")
m2g.export_params("fit5_params.txt")
m2g.export_angle("fit5_1D_major.txt", center=(0,0), angle=-11.8, length=80, stepsize=0.1)
m2g.export_angle("fit5_1D_minor.txt", center=(72.5,0), angle=27.1, length=80, stepsize=0.1)